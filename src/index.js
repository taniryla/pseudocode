...
// if any 2 numbers in the input array sum up to the target sum, return them in an array

// 2. What are the data inputs?
// non-empty array of distinct integers
// and integer representing a target sum

// 3. Can you restate the problem in your own words?

// addition of any 2 numbers equal to target sum
...
function twoNumberSum(arr, target) {
  // set-up an empty array into a result variable
  const result = [];
  // sort the array
  let sorted = arr.sort((a, b) => {
    return a - b;
  });
  // add numbers that equal target into the result array
